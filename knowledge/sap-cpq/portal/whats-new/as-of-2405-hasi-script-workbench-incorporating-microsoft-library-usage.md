# As of 2405: HaSi Script Workbench Incorporating Microsoft Library Usage | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/abe5bf645c9542a5bd4cbfdcc1a4876c/a6a50060e70e4001bb3833f66e6c9fc8.html?version=2603
**Crawled:** 2026-04-16
...
Importing the Microsoft library in the script workbench allows access to functions that can be used in a malicious way.

The malicious libraries discovered so far are Win32.

Actions to Take

Affected customers are all the customers that are using Win32 libraries.
