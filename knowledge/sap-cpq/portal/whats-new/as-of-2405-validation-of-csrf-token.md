...
**Source:** https://help.sap.com/docs/SAP_CPQ/abe5bf645c9542a5bd4cbfdcc1a4876c/57ac08475c1d4bf4ae0666f43d8efd95.html?version=2603
**Crawled:** 2026-04-16
...
UploadCartAttachment API (/Cart/UploadCartAttachment) has been updated. SAP CPQ has introduced AntiForgery validation for this API for security reasons. Now, when a user uses the drag and drop functionality for the Attachments feature on the Documents Tab of a Quote, SAP CPQ will send an additional token, "RequestVerificationToken," to ensure complete security.

Actions to Take

If customers are using this API in any way, they must ensure that this token is being sent correctly in headers with this request.
