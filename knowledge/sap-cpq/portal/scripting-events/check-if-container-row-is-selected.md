# Check if container row is selected | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/45cee5d60f94451c9093d378dede3513.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
This product configuration script sets container column isRowSelected in container Dealer Details to 1 or 0 depending on whether the row is selected.



container = Product.GetContainerByName("Dealer Details")
if container is not None:
    for row in container.Rows:
        if row.IsSelected:
            row.SetColumnValue("isRowSelected","1")
        else:
            row.SetColumnValue("isRowSelected","0")
Yes
No