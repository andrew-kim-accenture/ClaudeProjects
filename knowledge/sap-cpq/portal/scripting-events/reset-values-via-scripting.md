# Reset Values via Scripting | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/da463dc699a7484488d11423847770c1.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
You can reset values via Scripting by using the following method on the item level: DeleteConditionForColumn.

Example

For example, to delete the value from the MRC Discount Percent column, add the following line to the script:

context.Quote.GetAllItems()[0].DeleteConditionForColumn('MRCDiscountPercent')
