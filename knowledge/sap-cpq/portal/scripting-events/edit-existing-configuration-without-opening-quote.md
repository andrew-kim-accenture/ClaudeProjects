# Edit Existing Configuration Without Opening Quote | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/aba0e974c6b8483a9791f7e8bb98d35c.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
The endpoint can be used to directly edit the configuration by using the quoteId, itemId, and configurationId in the query string. Consequently, users can now be redirected to the Configurator and the configuration can now be edited without executing the Edit action on a quote item. In addition, you can use this endpoint to initiate a new configuration in the context of a specific quote.
...
https://yourdomain.cpq.cloud.sap/configurator/edit?quoteId=5491&itemId=2010&configurationId=be96b71c-8211-4546-abb5-6a2f87a4ae8b
