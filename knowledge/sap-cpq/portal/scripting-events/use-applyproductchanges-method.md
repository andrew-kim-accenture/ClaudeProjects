# Use ApplyProductChanges method | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/447892dbf6e5499fa3076a5a4fe5cfb0.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
Script Performance
Use ApplyProductChanges method
How to use ApplyProductChanges method?

Applies the changes of the product configuration on the container row level. After child product in the container row is configured through scripting, this method should be called in order to save it's current configuration.
