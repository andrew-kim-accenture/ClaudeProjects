# Product tab changed event | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/c7510043cb444db781ff242a536c8e82.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
An administrator can invoke script when product tab is changed in the configurator.

For "On Product Tab changed" event, the arg argument is of type Scripting.IProductTabChangedArgument

Select drop down attribute value and allow attribute on product tab changed event After changing tab event, if current tab is "Maintenance", select drop down value to "YES" for attribute "Maintenance Contract Signed"

and allow attribute "Maintenance License".



if arg.NameOfCurrentTab == "Maintenance":
    Product.Attributes.GetByName("Maintenance Contract Signed").SelectValue("YES")
    Product.Attributes.GetByName("Maintenance Licence").Allowed = True

Yes
No