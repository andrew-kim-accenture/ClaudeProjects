# Random Object | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/7fc27540a0f14bd1a10b639117a9d4d7/99c61b4c0d6045e096d7316cfd6fd06a.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
Clients can generate a random number through scripting.

The Random object is expose in the scripting and corresponding method to generate a random number:

The Random class is used in scripting to generate random number through scripting.

The class exposes the following methods:

Next() - random int

Next(int minValue, int maxValue) - random int within specified bounds

Next(int maxValue) - positive int less than specified maximum
