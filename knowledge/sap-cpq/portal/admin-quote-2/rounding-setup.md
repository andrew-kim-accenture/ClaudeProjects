...
**Source:** https://help.sap.com/docs/SAP_CPQ/bf1562733d5247f78f8f0a9c61e5382a/c91dc305d91d4ff6813f8ae1804bf342.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
You can create and apply rounding rules to columns on quotes. Rounding rules determine the number of digits used in price calculations, decimal places displayed, and affected currencies.

In Setup  Pricing/Calculations  Rounding Setup, you can create and apply rounding rules to columns on quotes. Rounding rules determine how many digits are used in price calculations, how many decimal places are displayed to users, and which currencies are affected by these calculations.
...
The MATH_DECIMAL_ROUNDING is a hidden setting that controls the default action. If you want to change it, you must reach out to SAP support.
