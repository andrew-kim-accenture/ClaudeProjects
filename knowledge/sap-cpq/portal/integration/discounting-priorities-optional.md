# Discounting Priorities (Optional) | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/f80fbcd4f1c74232839c30ce26886f07/16964d7500bb4c66827092e671ae33be.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
In SAP CPQ, discount to customers can be provided in Quote based on User, User Type, Product, Product Type, or Product Category conditions. In case there are multiple valid condition, you can maintain the priority of the conditions using the following procedure.
...
In left navigation bar, select Pricing/Calculations  Discounting Priorities.

Enter the following details:

Rank: 1 for the Product to have highest priority.

Rank for Product Type: 2
