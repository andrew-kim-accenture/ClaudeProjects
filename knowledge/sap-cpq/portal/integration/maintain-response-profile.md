# Maintain Response Profile | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/f80fbcd4f1c74232839c30ce26886f07/1816f99b86694af18f378e66d1051a0b.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
This step is only required for the replication of service contract products. The Response Profile attribute is automatically added to the list of global attributes when the SAP CPQ – SAP S/4HANA Cloud integration is enabled in SAP CPQ and must be maintained manually. You can do so using the following procedure:
...
Search for Response Profile in the list of attributes.

Choose Edit for Response Profile.

Choose Attribute values  Add Values and add the following details:

Value: For example, <First Level Response Time>

Value Code: For example, <FIRST>

The Response Profile must match the response profile of the service contract product in SAP S/4HANA Cloud.
