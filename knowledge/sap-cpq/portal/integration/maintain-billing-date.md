# Maintain Billing Date | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/f80fbcd4f1c74232839c30ce26886f07/d749f36291be4e3fa0b39875f9656c9c.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
This step is only required for the replication of service contract products. The Billing Date attribute is automatically added to the list of global attributes when the SAP CPQ – SAP S/4HANA Cloud integration is enabled in SAP CPQ and must be maintained manually. You can do so using the following procedure:
...
Search for Billing Date in the list of attributes.

Choose Edit for Billing Date.

Choose Attribute values  Add Values and add the following details:

Value: For example, <First of the Month>

Value Code: For example, <BILL0002>

The Value Code must match the billing date of service contract product in SAP S/4HANA Cloud.
