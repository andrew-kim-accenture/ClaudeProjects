...
**Source:** https://help.sap.com/docs/SAP_CPQ/884885f05e6b4c8082254d4d9d63f19b/74465a8b82db424b9dbc39d5e39005a9.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
First of all, discounting rules have to be defined, that will limit quote owner when setting discount, so that 50 will trigger an exceeded discount flag. This section is described in Discounts/Multipliers section of this manual, so refer there for more details about this simple step. Once the discounting rule is defined, we can add an approval rule that will treat discounting.
