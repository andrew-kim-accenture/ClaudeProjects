# Attributes Audit Trail | SAP Help Portal

**Source:** https://help.sap.com/docs/SAP_CPQ/884885f05e6b4c8082254d4d9d63f19b/658c657655b04582815598c71a06009a.html?locale=en-US&state=PRODUCTION&version=2603
**Crawled:** 2026-04-16
...
This functionality allows administrators to track all changes performed on attributes. Specifically, the changes logged here are attribute definition changes performed in the Setup.
...
Entity – the type of SAP CPQ object that is being changed (such as Attribute or Attribute Container Content).

Entity ID – the identity of the specific SAP CPQ object that is being changed (such as the specific system ID of an attribute).
